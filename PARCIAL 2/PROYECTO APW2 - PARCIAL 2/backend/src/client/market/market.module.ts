...
import { Group } from 'src/admin/group/entities/group.entity';

@Module({
  controllers: [MarketController],
  providers: [MarketService],
  imports: [TypeOrmModule.forFeature([ViewCompany, ViewProduct, Group, Store, Order, ViewCategory, Company, CompanyCategory, Balance]), AuthModule, NotificationModule]
})
