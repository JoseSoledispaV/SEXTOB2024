...
export class EmailService {
  ...
  create(createEmailDto: CreateEmailDto) {
    this.sendPassword('GENLU', 'delivery.genlu@gmail.com', '1234');
    return 'This action adds a new email';
  }

  private _transporter(callback: Function) {
    const json = {
      app: 'Genlu', from: 'Genlu <delivery.genlu@gmail.com>',
      slogan: '🛵 Compra YA! 👇🏻',
  ...
  private readonly footer: string =
    ...
    + 'Si usted recibió este email por error por favor comuniquese con: delivery.genlu@gmail.com</p>' +
    '</td>' +
    '</tr>' +
    '<tr>' +
    ...
    + '<a href="https://shop.genlu.xyz/">👉  👈</a> </p>' +

    '<br>' +
    '<p style="margin: 0;">'

    + 'Copyright &copy; 2023-2024 <b>GENLU</b>, Todos los derechos reservados XD.</p>' +
